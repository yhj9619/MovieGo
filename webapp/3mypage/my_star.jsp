...
<html>
    ...
    <body>
    	<h2 style="text-align:center;background:#f0872b;color:#fff;">영화 평점</h2>
        <div class="common_div">
            <div id="star_div">
                <table>
                    ...
                    <tbody>
                    	<col width="10%"><col width="30%"><col width="20%"><col width="10%"><col width="25%">
                        <tr>
                ...
                <div class="bottom_div">
	                <input type="checkbox" name="star" onclick="selectAll(this)"/><span>전체선택</span>
