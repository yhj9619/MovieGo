...
<html>
    ...
    <body>
    	<h2 style="text-align:center;background:#f0872b;color:#fff;">댓글 단 게시글</h2>
        <div class="common_div">
            <div id="comment_div">
                <table>
                    ...
                    <tbody>
                    	<col width="10%"><col width="20%"><col width="60%"><col width="25%">
                        <tr>
                            <td><input type="checkbox" name="comment"/></td>
                            <td>평론</td>
                            <td>게시글 제목</td>
                            <td>2021.10.24</td>
                        </tr>
