...
<html>
    <head>
        ...
        <script>
	        function selectAll(selectAll)  {
        	  const checkboxes 
        	       = document.getElementsByName('review');
    ...
    <body>
    	<h2 style="text-align:center;background:#f0872b;color:#fff;">영화 평론</h2>
        <div class="common_div">
            <div id="review_div">
                <table>
                    ...
                    <tbody>
                    	<col width="10%"><col width="30%"><col width="40%"><col width="10%"><col width="10%"><col width="25%">
                        <tr>
                            <td><input type="checkbox" name="review"/></td>
                            <td>영화제목</td>
                            <td>평론제목</td>
                            <td>0</td>
                            <td>0</td>
                ...
                <div class="bottom_div">
	                <input type="checkbox" name="review" onclick="selectAll(this)"/><span>전체선택</span>
