...
.section input[id="slide04"]:checked ~ .slidewrap li:nth-child(3) .textbox h3
	{
	opacity: 1;
	transform: translateY(0);
	transition-delay: .2s;
...
.section input[id="slide04"]:checked ~ .slidewrap li:nth-child(3) .textbox p
	{
	opacity: 1;
	transform: translateY(0);
	transition-delay: .4s;
...
.section .left {
	left: 30px;
	background: url("../MovieGo_image/left.png") center center/100%
		no-repeat;
}

.section .right {
	right: 30px;
	background: url("../MovieGo_image/right.png") center center/100%
		no-repeat;
}
...
<body>
	...
	<header>
		<nav>
			<div id="menu1">
				<ul>
					<li><a href="index.jsp"><img src="image\Logo3-2_white.png"
							alt="" href="index.jsp" class="" width="400"></a></li>
					<li></li>
					...
					if (m != null) {
					%>
					<li><a href="../../3mypage/mypage.jsp"><%=m.getNickname()%>님의
							마이페이지</a></li>
			...
			<ul class="slidelist">
				...
				<li class="slideitem"><a>
						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/gucci.png" width="30px" height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/westsidestory.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/Thepoliceman.png" width="30px"
						height="570px" />
				</a></li>
				<li class="slideitem"><a>
						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/kingsman.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/eternals.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/lincoln.png" width="30px"
						height="570px" />
				</a></li>
				<li class="slideitem"><a>
						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/happynewyear.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/miracle.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/voice.png" width="30px" height="570px" />
				</a></li>
				...
				<li class="slideitem"><a>
						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/nowayhome.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/peninsula.png" width="30px"
						height="570px" />

						<div class="textbox">
							<h3></h3>
							<p></p>
						</div> <img src="../MovieGo_image/midnight.png" width="30px"
						height="570px" />
				</a></li>
	...
	<section class="sectionMake">
		<div>
			<ul>
				<li><a href="#" class="sectionMakeTitle">자유게시판 <span>more+</span></a>
					<ul class="subSection">
		...
		<div>
			<ul>
				<li><a href="#" class="sectionMakeTitle">리뷰게시판 <span>more+</span></a>
					<ul class="subSection">
		...
		<div>
			<ul>
				<li><a href="#" class="sectionMakeTitle">평론게시판 <span>more+</span></a>
					<ul class="subSection">
						<li><a href="#">1. 미드나이트 후기_정신건강에 해롭습니다.</a></li>
						<li><a href="#">2. 아포칼립스 좀비 바이러스 영화 리뷰 데드 돈 다이</a></li>
						<li><a href="#">3. 경관의 피 시사회 리뷰(무대인사!!)</a></li>
